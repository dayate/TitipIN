<script lang="ts">
	...
	import { Store, History, ArrowRight } from 'lucide-svelte';

	let { data } = $props();
</script>

<svelte:head>
	<title>Pilih Lapak - Riwayat - Mak Unyil</title>
</svelte:head>

<div class="space-y-6">
	<div>
		<h1 class="text-2xl font-bold text-foreground">Riwayat Setoran</h1>
		<p class="text-muted-foreground">Pilih lapak untuk melihat riwayat</p>
	</div>
	...
	{:else}
		<div class="grid gap-4 sm:grid-cols-2">
			{#each data.stores as store}
				<a href="/app/{store.id}/history" class="block">
