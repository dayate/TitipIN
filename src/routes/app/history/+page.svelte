        ...
        {#each data.transactions as tx}
          <Card>
            <CardContent class="pt-4">
              ...
              <div class="grid grid-cols-3 gap-4 text-center py-3 bg-muted rounded-lg mb-3">
                <div>
                  <p class="text-xl font-bold text-foreground">{tx.totalItemsIn}</p>
              ...
              {#if tx.items && tx.items.length > 0}
                <details class="mt-3">
                  <summary class="text-sm text-primary cursor-pointer">Lihat Detail</summary>
