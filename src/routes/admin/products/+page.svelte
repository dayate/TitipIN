<script lang="ts">
	...
	import { Store, Package, ArrowRight } from 'lucide-svelte';

	let { data } = $props();
</script>

<svelte:head>
	<title>Pilih Lapak - Produk - Mak Unyil</title>
</svelte:head>

<div class="space-y-6">
	<div>
		<h1 class="text-2xl font-bold text-foreground">Kelola Produk</h1>
		<p class="text-muted-foreground">Pilih lapak untuk mengelola produk</p>
	</div>
	...
	{:else}
		<div class="grid gap-4 sm:grid-cols-2">
			{#each data.stores as store}
				<a href="/admin/stores/{store.id}/products" class="block">
