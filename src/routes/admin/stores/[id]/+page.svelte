...
<div class="mx-auto max-w-4xl space-y-6">
	...
	<div class="flex items-start justify-between">
		...
		<span
			class="rounded-full px-4 py-1.5 text-sm font-medium shadow-sm {data.store
				.isOpen
	...
	<Card>
		...
		<div class="grid grid-cols-4 gap-2">
			...
			<form method="POST" action="?/toggleStatus" use:enhance class="contents">
				...
				>
					<Power
						class="h-5 w-5 {data.store.isOpen
							? 'text-green-500'
							: 'text-red-500'}"
					/>
	...
	<!-- Analytics & Reports -->
	<Card
		class="border-blue-500/20 bg-gradient-to-br from-blue-500/5 to-blue-600/5"
	>
		<h3
			class="mb-3 text-xs font-semibold uppercase tracking-wide text-blue-500"
		>
			📊 Analytics & Reports
		</h3>
		<div class="grid grid-cols-4 gap-2">
	...
	<Card class="border-destructive/30">
		<h3
			class="mb-4 text-sm font-semibold uppercase tracking-wide text-destructive"
		>
			Zona Bahaya
		</h3>
	...
	>
		<Card class="w-full max-w-md">
			...
			<p class="mt-2 text-muted-foreground">
				Semua data termasuk anggota, produk, dan transaksi akan dihapus
				permanen.
			</p>
