...
<div class="container max-w-6xl mx-auto p-4 space-y-6">
  ...
  {#if lowReliability.length > 0}
    <div
      class="p-4 rounded-lg bg-red-500/10 border border-red-500/20 flex items-start gap-3"
    >
        ...
        <Card class={getScoreBg(supplier.reliabilityScore)}>
          ...
          >
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div>
                <div
                  class="flex items-center justify-center gap-1 text-green-500"
                >
                  <CheckCircle class="h-4 w-4" />
                  <span class="font-semibold"
                    >{supplier.completedTransactions}</span
                  >
                </div>
              ...
              <div>
                ...
                >
                  ...
                  <span class="font-semibold"
                    >{supplier.cancelledBySupplier}</span
                  >
                </div>
  ...
  {:else}
    <Card>
      <div class="py-8 text-center">
        ...
        <p class="text-muted-foreground">
          Data reliabilitas akan muncul setelah transaksi selesai
        </p>
      </div>
    </Card>
  {/if}
